var socializeit = function(options) {
  ...
  var d = document,
    ...
    //Facebook,Twitter,Google,Pinterest,Tumblr,Reddit
  var sitesConfig = {
        'facebook':    {name: 'Facebook',
                        color: '#3b579d',
                        iconClassName: 'fa fa-facebook-square fa-2x fa-fw',

                        url: 'http://www.facebook.com/sharer.php?u='+ u +'&t=' + t},
        'twitter':     {name: 'Twitter',
                        color: '#28a9e0',
                        iconClassName: 'fa fa-twitter-square fa-2x fa-fw',
                        url: 'http://twitter.com/home?status=Reading%20about%20this:%20'+t+'%20-%20' + u},
        'google':      {name: 'Google',
                        color: '#df4a32',
                        iconClassName: 'fa fa-google-plus-square fa-2x fa-fw',
			            url: 'https://plus.google.com/share?url='+ u},
		'pinterest':    {name: 'Pinterest',
                        color: '#CD1D1F',
                        iconClassName: 'fa fa-pinterest-square fa-2x fa-fw',
                        url: '//assets.pinterest.com/js/pinmarklet.js',
                        includeScript: true},
	    'tumblr':       {name: 'Tumblr',
                        color: '#35465c',
                        iconClassName: 'fa fa-tumblr-square fa-2x fa-fw',
	                    url: 'http://www.tumblr.com/share/link?url='+ u + '&name='+ t },
	    'reddit':       {name: 'Reddit',
                        color: '#ff4500',
                        iconClassName: 'fa fa-reddit-square fa-2x fa-fw',
	                    url: 'http://reddit.com/submit?url='+ u + '&title=' + t}
    };

    var sites = [];
    if (options.pack == 1) {
        sites = [sitesConfig.facebook,sitesConfig.twitter,sitesConfig.google,sitesConfig.pinterest,sitesConfig.tumblr,sitesConfig.reddit];
    }
    else
    {
    ...
    if (options.version === 2) {
        ...
        for (var i = 0, ilen = sites.length; i < ilen; i += 1) {
            ...
            if (includeScript) {
                ...
                onClickAction = 'window.open(socializeit.getURL(\''+site+'\'), \'sharer\', \'toolbar=0,status=0,width=700,height=500,resizable=yes,scrollbars=yes\');return false;';
            }
            html += '<li>' +
    ...
    loadStyleSheet( '//'+ domain + '/plugins/fontawesome/css/font-awesome.min.css');
